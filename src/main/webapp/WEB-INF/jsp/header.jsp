          ...
          <div class="container-fluid">
            <div class="row d-flex align-items-center">
              <div class="col-md-2 col-sm-6">
                <div class="main-logo">
                  <a href="index.html">
                    <img src="images/maibbbn-logo.png" alt="logo">
                  </a>
                </div>
              </div>
                  ...
                  <div class="main-menu stellarnav desktop light">
                    <ul class="menu-list list-unstyled">
                      ...
                      <li class="menu-item has-sub">
                        ...
                        <ul class="submenu">
                          <li>
                            <a href="about.html" class="text-uppercase">About <span class="badge bg-primary">PRO</span></a>
                          </li>
                          <li>
                            <a href="shop.html" class="text-uppercase">Shop <span class="badge bg-primary">PRO</span></a>
                          </li>
                          <li>
                            <a href="blog.html" class="text-uppercase">Blog <span class="badge bg-primary">PRO</span></a>
                          </li>
                          <li>
                            <a href="styles.html" class="text-uppercase">Styles <span class="badge bg-primary">PRO</span></a>
                          </li>
                          <li>
                            <a href="single-product.html" class="text-uppercase">Single Product <span class="badge bg-primary">PRO</span></a>
                          </li>
                          <li>
                            <a href="single-post.html" class="text-uppercase">Single Post <span class="badge bg-primary">PRO</span></a>
                          </li>
                          <li>
                            <a href="thank-you.html" class="text-uppercase">Thank You <span class="badge bg-primary">PRO</span></a>
                          </li>
                          <li>
                            <a href="contact.html" class="text-uppercase">Contact <span class="badge bg-primary">PRO</span></a>
                          </li>
                        </ul>
                      </li>
                      <li class="menu-item">
